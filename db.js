...
// Enable foreign-key enforcement so `notes.server_id` ON DELETE CASCADE
// actually fires when a server row is removed (OFF by default in SQLite).
...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS notes (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    server_id INTEGER,                 -- NULL = global note (not tied to a server)
